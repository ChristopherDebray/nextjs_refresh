...
export default function ErrorPageContent({ reset }: ErrorPageContentProps) {
  return (
        ...
        <div className="md:col-span-7 order-1 md:order-2 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-secondary text-lg md:text-xl max-w-lg leading-relaxed">
              Nos équipes techniques travaillent pour rétablir le flux. Sillage
              Direct assure la continuité de votre intendance avec soin.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              onClick={reset}
              className="flex items-center justify-center gap-3 bg-linear-to-br from-primary to-primary-container text-on-primary px-8 py-4 rounded-xl font-semibold shadow-lg shadow-primary/20 active:scale-95 transition-all duration-200 cursor-pointer"
            >
              <Icon name="refresh" />
              Rafraîchir la page
            </button>
          ...
          <div className="pt-12">
            <div className="bg-surface-container-low rounded-2xl p-6 border border-outline-variant/10">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="text-xs font-bold text-primary">85% Prêt</span>
              </div>
              ...
              <p className="mt-4 text-xs text-secondary leading-relaxed italic">
                "La nature ne se presse pas, pourtant tout est accompli." – Lao
                Tzu
              </p>
            </div>
          </div>
